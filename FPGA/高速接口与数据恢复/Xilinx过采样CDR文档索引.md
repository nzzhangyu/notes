...
> 小记：XAPP881 和 XAPP1294 之后，AMD/Xilinx 仍有较新的过采样数据恢复文档。通用方向优先阅读 XAPP1240；高速 SelectIO 四倍采样可继续阅读 XAPP523；突发模式再看 XAPP1252 和 XAPP1277。

## 文档一览

| 文档 | 日期/版本 | 主要内容 | 阅读建议 |
| --- | --- | --- | --- |
| [XAPP523：LVDS 4x Asynchronous Oversampling Using 7 Series](https://docs.amd.com/v/u/en-US/xapp523-lvds-4x-asynchronous-oversampling) | v1.1，2017-05-17 | 7 Series LVDS、SelectIO、4倍异步过采样 | 与 XAPP881 最接近，用于了解其在7系列中的延续 |
...
相较于 XAPP881/XAPP1294 的固定4倍采样结构，XAPP1240 的 NIDRU 更通用：
...
2. [[XAPP881 Virtex-6 4倍异步过采样与DRU]]：理解高速 SelectIO、内部样本重映射和固定宽度输出。
3. XAPP523：了解7 Series高速 LVDS 四倍采样结构。
4. XAPP1240：学习分数倍过采样、数字环路、动态配置和眼图扫描。
5. XAPP1252/XAPP1277：需要突发模式快速锁定时再读。
...
- [[XAPP881 Virtex-6 4倍异步过采样与DRU]]

## References

- AMD/Xilinx 官方文档库；上述版本与发布日期核对于 2026-07-23。
